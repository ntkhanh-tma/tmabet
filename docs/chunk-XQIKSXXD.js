...
var VERSION = /* @__PURE__ */ new Version("20.3.24");
...
function SECURITY_SCHEMA() {
  if (!_SECURITY_SCHEMA) {
    ...
    registerContext(SecurityContext.URL, MATH_ML_NAMESPACE2, [
      // MathML namespace
    ...
    registerContext(SecurityContext.ATTRIBUTE_NO_BINDING, SVG_NAMESPACE2, [
...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
  const tAttributes = rootSelectorOrNode ? ["ng-version", "20.3.24"] : (
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-XQIKSXXD.js.map
